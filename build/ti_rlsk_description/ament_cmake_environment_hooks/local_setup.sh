...
: ${AMENT_CURRENT_PREFIX:="/thesis_project/install/ti_rlsk_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ti_rlsk_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ti_rlsk_description/environment/path.sh"
